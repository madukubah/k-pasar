...
class Gallery extends User_Controller {
	...
	public function index()
	{
		...
		$table[ "rows" ] = $this->gallery_model->galleries_by_store_id( $this->store->id, Gallery::IMAGE_TYPE, $pagination['start_record'], $pagination['limit_per_page'] )->result();
